...
fun getEmpresasFromPHP(): Array<Empresa> {
    val url = URL("http://192.168.251.190/get_empresas.php") // Cambia por la ruta correcta
...
fun getEmpresasByTagsFromPHP(tags: String): Array<Empresa> {
    val url = URL("http://192.168.251.190/get_empresas_where_tags.php?tags=$tags") // Cambia por la ruta correcta
    val connection = url.openConnection() as HttpURLConnection
    connection.requestMethod = "GET"
...
fun getEmpresasByNombresFromPHP(nombres: Array<String>): Array<Empresa> {
    val url = URL("http://192.168.251.190/get_empresas_by_nombres.php") // Cambia por la ruta correcta
    val connection = url.openConnection() as HttpURLConnection
